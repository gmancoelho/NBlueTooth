...
public class BluetoothChatService {
    ...
    private boolean mIsDeviceGeneric;
    private int mState;
    ...
    public BluetoothChatService(Handler handler,
                                boolean isDeviceGeneric) {
        mState = STATE_NONE;
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mHandler = handler;
        mIsDeviceGeneric = isDeviceGeneric;
    }
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothChatService
    ...
    private class AcceptThread extends Thread {
        ...
        public void cancel() {
            ...
            try {
                ...
                // Sometimes the socket is null, so we catch the exception here
            }
        }
    }
